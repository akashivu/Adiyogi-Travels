...
public class EmailTemplateService {
    ...
    private static final String SUPPORT_EMAIL = "noreply@elixway.com";
    private static final String SUPPORT_PHONE = "+91 76769 43788";
    private static final String WEBSITE        = "www.elixway.com";
    ...
    private String fmtRef(Object id) {
        return String.format("ELX-%06d", Long.parseLong(String.valueOf(id)));
    }
    ...
    private String styles() {
        return """
                ...
                *{margin:0;padding:0;box-sizing:border-box;
                ...
                body{background:#eef2f7;padding:30px;color:#1e293b;}

                .container{max-width:680px;margin:auto;background:#ffffff;
                    border-radius:16px;overflow:hidden;border:1px solid #dbe4ee;
                ...
                h2{color:#0f172a;font-size:20px;margin-bottom:8px;}
                p{line-height:1.75;font-size:15px;color:#334155;}

                table{width:100%;border-collapse:collapse;margin:22px 0;table-layout:fixed;}
                th{background:#eff6ff;color:#1d4ed8;padding:13px 15px;text-align:left;
                    width:38%;border:1px solid #dbeafe;font-size:13px;font-weight:600;}
                td{padding:13px 15px;border:1px solid #e2e8f0;font-size:14px;color:#334155;
                ...
                .card-success{background:#eff6ff;border-left:5px solid #2563eb;
                    padding:20px 22px;margin:20px 0;border-radius:10px;}
                .card-success-title{color:#1e3a8a;font-size:16px;font-weight:700;
                    margin-bottom:8px;}
                .card-success p{font-size:14px;color:#1e40af;line-height:1.7;}

                .card{background:#f8fafc;border-left:5px solid #2563eb;
                    padding:20px 22px;margin:20px 0;border-radius:10px;}
                .card-title{color:#0f172a;font-size:15px;font-weight:700;margin-bottom:12px;}
                .card p{font-size:14px;color:#334155;line-height:1.9;}
                .card a{color:#1d4ed8;text-decoration:none;font-weight:600;}

                .divider{height:1px;background:#e2e8f0;margin:26px 0;}

                .otp-box{text-align:center;background:#eff6ff;
                    border:2px dashed #2563eb;border-radius:12px;
                    padding:25px;margin:25px 0;}
                .otp-code{font-size:42px;font-weight:bold;color:#1d4ed8;
                    letter-spacing:8px;font-variant-numeric:tabular-nums;
                    white-space:nowrap;}

                .footer{background:#f8fafc;padding:24px 35px;text-align:center;
                    color:#64748b;font-size:13px;border-top:1px solid #e2e8f0;}
                ...
                @media(max-width:620px){
                    ...
                    td{display:block;width:auto;flex:0 1 auto;border:none;
                        ...
                        color:#0f172a;text-align:right;white-space:nowrap;
    ...
    private String header(String title, String subtitle) {
        return "<div class='header'>"
                + "<div class='logo-wrap'>"
                + "<span class='logo-text'>ElixWay</span>"
                + "</div>"
    ...
    private String footer() {
        return "<div class='footer'>"
                + "<p><b>ElixWay</b> — Reliable rides, every time.</p>"
                + "<div class='footer-links'>"
                + "<a href='mailto:" + SUPPORT_EMAIL + "'>" + SUPPORT_EMAIL + "</a>"
                + "<a href='tel:+917676943788'>"           + SUPPORT_PHONE  + "</a>"
                + "<a href='https://"  + WEBSITE + "'>"    + WEBSITE        + "</a>"
                + "</div>"
                + "<p style='margin-top:10px;'>© 2026 ElixWay. All Rights Reserved.</p>"
                + "</div>";
    }
    ...
    public String buildCustomerBookingEmail(Booking booking) {
        ...
        return "<!DOCTYPE html><html><head>"
                ...
                + "<title>Booking Confirmed – ElixWay</title>"
                + styles()
                ...
                + "<p>Thank you for choosing <strong>ElixWay</strong>. "
    ...
    public String buildAdminBookingEmail(Booking booking) {
        ...
        return "<!DOCTYPE html><html><head>"
                + "<meta charset='UTF-8'>"
                + "<meta name='viewport' content='width=device-width,initial-scale=1'>"
                + "<title>New Booking Alert – ElixWay Admin</title>"
                + styles()
                + "</head><body><div class='container'>"
    ...
    public String buildOtpEmail(String fullName, String otp) {
        ...
        return "<!DOCTYPE html><html><head>"
                + "<meta charset='UTF-8'>"
                + "<meta name='viewport' content='width=device-width,initial-scale=1'>"
                + "<title>Verify Your Email – ElixWay</title>"
                + styles()
                + "</head><body><div class='container'>"
                + header("Verify Your Email",
                "Complete your ElixWay registration")
                + "<div class='content'>"
                + "<h2>Hello " + fullName + "</h2>"
                + "<p>Thank you for registering with <strong>ElixWay</strong>.</p>"
                + "<br>"
            ...
            """
                ...
                """
                    ...
                    <p>
                        ...
                        <strong>ElixWay</strong> account password.
